...
export function InteractiveHoverButton({
  ...
  return (
    <button
      className={cn(
        "group relative w-auto cursor-pointer overflow-hidden rounded-full border bg-transparent p-2 px-6 text-center font-semibold",
        className
      )}
      {...props}
    >
      <div className="flex items-center gap-2">
        <div className="bg-[#E18126] h-2 w-2 rounded-full transition-all duration-300 group-hover:scale-[100.8]"></div>
