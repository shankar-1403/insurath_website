...
export default function Home() {
  ...
  const customers = [
    ...
    { name: "Priya Sharma", designation:"Business Owner", rating: 5, description: "As our company expanded, our existing policies were inadequate. Insurath evaluated risks and suggested comprehensive coverage. They streamlined group health and liability protection. We now operate with confidence and proper safeguards." },
    ...
    { name: "Meera Joshi", designation:"HR Director", rating: 5, description: "As our workforce expanded, managing employee health coverage became complex. Insurath helped restructure our group insurance policy with better benefits and cost efficiency. Their team handled onboarding, documentation, and employee queries smoothly. This allowed HR to focus on people, while they ensured complete protection." },
    ...
    { name: "Kavita Nair", designation:"Homemaker", rating: 5, description: "When my father was hospitalized unexpectedly, we were unsure about the claim process. Insurath guided us through documentation and coordinated with the insurer. The claim was settled smoothly without delays. Their support gave us relief during a stressful time." },
  ] 
